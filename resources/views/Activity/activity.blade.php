...
<body>
    ...
    <section class="hero-section d-flex align-items-center justify-content-center text-white position-relative"
        style="height: 50vh; background: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url('/images/activity/bgactivity.png'); background-size: cover; background-position: center; margin-top: 56px;">
