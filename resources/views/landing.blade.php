            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead fs-5 mb-4">
                        Tempat mendukung mimpi dan mendorongmu maju. Dapatkan dukungan dan motivasi yang tak terbatas
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-20">
                    ...
                    <p class="fs-5 text-muted mb-4 text-center text-lg-start">
                        ...
                        that supports your personal and professional development, and be inspired by fellow members with
                        similar interests.
                    </p>
                    <div
                    ...
                    <div class="d-flex flex-column flex-lg-row gap-4 mt-5 position-relative z-1 justify-content-center">
                        ...
                        <div class="card border-0 shadow-sm" style="width: 100%; max-width: 300px;">
                            <div class="card-body">
                                ...
                                <p class="card-text text-muted">
                                    Connect with expert counselors via our app and discuss mental health solutions with
                                    the community.
                                </p>
                                <div class="d-flex justify-content-between align-items-center mt-4">
            ...
            <section class="col">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">
                            Join UXID and learn the art of designing better user experiences! Find workshops, mentoring
            ...
            <section class="col">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">
                            Developer Circles by Meta is a place for those of you who want to learn coding, AI, and web
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    ...
                    <p class="lead mb-4">
                        Discover exciting projects from our community. The Project Gallery is a place where users can
